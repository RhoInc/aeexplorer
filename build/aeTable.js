(function(global, factory) {
  ...
  \------------------------------------------------------------------------------------------------*/
    function setDefaults(chart) {
        // non data-driven settings
        if (chart.raw_data === undefined) {
            /////////////////////////////
            ...
            (function() {
                ...
                groupsObject = allGroups.map(function(d) {
                    return { key: d };
                });
                ...
                //////////////////////////////////////////////////////////////
                for (x in chart.config.variables) {
                    varList = d3.keys(chart.raw_data[0]).concat('data_all');
